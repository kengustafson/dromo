...
async function getData() {
  ...
  alert(JSON.stringify(todoData) + "  from getData");
...
export default class AgendaScreen extends Component {
  ...
  componentDidMount() {
    ...
    alert(JSON.stringify(this.state.items) + "  from setState");
  };

  render() {
    setTimeout(alert(JSON.stringify(this.state.items) + "  from render"), 10000);
    return (
      <React.Fragment>
      <View
        style={{
